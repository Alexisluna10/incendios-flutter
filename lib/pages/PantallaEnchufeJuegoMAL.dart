...
class _PreguntaScreenState extends State<PreguntaScreen> {
  ...
  void responder(bool esCorrecta) {
    // Si el usuario presiona el botón "CORRECTA" (true)
    if (esCorrecta) {
      // Te manda a la pantalla de precaución 1
      Navigator.pushNamed(context, '/precaucion_malo_enchufe_1');
    }
    // Si el usuario presiona el botón "INCORRECTA" (false)
    else {
      // Te manda a la pantalla de enchufe correcto 2
      Navigator.pushNamed(context, '/correcto_enchufe_2');
    }
  }
